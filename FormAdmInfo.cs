    ...
    public partial class FormAdmInfo : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "" && textBox3.Text != "")
            {
                ...
                if (Result != null)
                {
                    MessageBox.Show("Информация с таким названием уже существует!", "Ошибка.",
                ...
                else
                {
                    ...
                    {
                        MessageBox.Show("Информация успешно добавлена!", "Добавление.", 
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            DialogResult Del = MessageBox.Show("Вы уверенны что хотите удалить данную информацию?",
